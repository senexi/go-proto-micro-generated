...
public final class PartnerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<my.company.Partner,
      my.company.AddPartnerReply> getAddPartnerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddPartner",
      requestType = my.company.Partner.class,
      responseType = my.company.AddPartnerReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<my.company.Partner,
      my.company.AddPartnerReply> getAddPartnerMethod() {
    io.grpc.MethodDescriptor<my.company.Partner, my.company.AddPartnerReply> getAddPartnerMethod;
      ...
      synchronized (PartnerServiceGrpc.class) {
        if ((getAddPartnerMethod = PartnerServiceGrpc.getAddPartnerMethod) == null) {
          PartnerServiceGrpc.getAddPartnerMethod = getAddPartnerMethod = 
              io.grpc.MethodDescriptor.<my.company.Partner, my.company.AddPartnerReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  my.company.AddPartnerReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<my.company.SearchRequest,
      my.company.PartnerList> getGetPartnersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPartners",
      requestType = my.company.SearchRequest.class,
      responseType = my.company.PartnerList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<my.company.SearchRequest,
      my.company.PartnerList> getGetPartnersMethod() {
    io.grpc.MethodDescriptor<my.company.SearchRequest, my.company.PartnerList> getGetPartnersMethod;
      ...
      synchronized (PartnerServiceGrpc.class) {
        if ((getGetPartnersMethod = PartnerServiceGrpc.getGetPartnersMethod) == null) {
          PartnerServiceGrpc.getGetPartnersMethod = getGetPartnersMethod = 
              io.grpc.MethodDescriptor.<my.company.SearchRequest, my.company.PartnerList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "proto.PartnerService", "GetPartners"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  my.company.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  my.company.PartnerList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<my.company.SearchRequest,
      my.company.PartnerList> getSearchPartnerMethod;
  ...
  public static io.grpc.MethodDescriptor<my.company.SearchRequest,
      my.company.PartnerList> getSearchPartnerMethod() {
    io.grpc.MethodDescriptor<my.company.SearchRequest, my.company.PartnerList> getSearchPartnerMethod;
  ...
  public static abstract class PartnerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addPartner(my.company.Partner request,
        io.grpc.stub.StreamObserver<my.company.AddPartnerReply> responseObserver) {
      asyncUnimplementedUnaryCall(getAddPartnerMethod(), responseObserver);
    }

    /**
     */
    public void getPartners(my.company.SearchRequest request,
        io.grpc.stub.StreamObserver<my.company.PartnerList> responseObserver) {
      asyncUnimplementedUnaryCall(getGetPartnersMethod(), responseObserver);
    }

    /**
     */
    public void searchPartner(my.company.SearchRequest request,
        io.grpc.stub.StreamObserver<my.company.PartnerList> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                my.company.Partner,
                my.company.AddPartnerReply>(
                  this, METHODID_ADD_PARTNER)))
          .addMethod(
            getGetPartnersMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                my.company.SearchRequest,
                my.company.PartnerList>(
  ...
  public static final class PartnerServiceBlockingStub extends io.grpc.stub.AbstractStub<PartnerServiceBlockingStub> {
    ...
    /**
     */
    public my.company.AddPartnerReply addPartner(my.company.Partner request) {
    ...
    /**
     */
    public my.company.PartnerList getPartners(my.company.SearchRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public my.company.PartnerList searchPartner(my.company.SearchRequest request) {
      return blockingUnaryCall(
  ...
  public static final class PartnerServiceFutureStub extends io.grpc.stub.AbstractStub<PartnerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<my.company.AddPartnerReply> addPartner(
        my.company.Partner request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<my.company.PartnerList> getPartners(
        my.company.SearchRequest request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<my.company.PartnerList> searchPartner(
        my.company.SearchRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_PARTNER:
          serviceImpl.addPartner((my.company.Partner) request,
              (io.grpc.stub.StreamObserver<my.company.AddPartnerReply>) responseObserver);
          break;
        case METHODID_GET_PARTNERS:
          serviceImpl.getPartners((my.company.SearchRequest) request,
              (io.grpc.stub.StreamObserver<my.company.PartnerList>) responseObserver);
          break;
        case METHODID_SEARCH_PARTNER:
          serviceImpl.searchPartner((my.company.SearchRequest) request,
              (io.grpc.stub.StreamObserver<my.company.PartnerList>) responseObserver);
          break;
        default:
