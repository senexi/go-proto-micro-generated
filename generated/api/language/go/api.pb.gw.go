...
var (
	filter_PartnerService_GetPartners_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func local_request_PartnerService_GetPartners_0(ctx context.Context, marshaler runtime.Marshaler, server PartnerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_PartnerService_GetPartners_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_PartnerService_GetPartners_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"partners"}, "", runtime.AssumeColonVerbOpt(true)))
)
